...
export default function SignInForm() {
  ...
  const handleLogin = async () => {
    ...
    if (loginMethod == "email") {
      const payload = {
        email: loginFormData.identifier,
        password: loginFormData.password,
      };
      const res = await auth.signinWithEmail(payload);
      if (res.success) {
      ...
      const payload = {
        username: loginFormData.identifier,
        password: loginFormData.password,
      };
      const res = await auth.signinWithUsername(payload);
      if (res.success) {
        toast.success(res.message);
        // router.push("/market");
      } else {
